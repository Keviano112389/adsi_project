...
def save_sets(X_train=None, y_train=None, X_val=None, y_val=None, X_test=None, y_test=None, path='desktop/adsi_project/data/processed/'):
    ...
    y_test: Numpy Array
        Target for the testing set
    path : str
        Path to the folder where the sets will be saved (default: 'desktop/adsi_project/data/processed/')
...
def load_sets(path='desktop/adsi_project/data/processed/', val=False):
    """Load the different locally save sets

    Parameters
    ----------
    path : str
        Path to the folder where the sets are saved (default: 'desktop/adsi_project/data/processed/')
